...
const config = {
  ...
  organizationName: "dalibo", // Usually your GitHub org/user name.
  projectName: "cnpg-plugin-pgbackrest", // Usually your repo name.
