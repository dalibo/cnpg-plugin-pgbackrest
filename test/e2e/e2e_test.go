...
func setup() {
	...
	s := kubernetes.InstallSpec{
		ManifestUrl: "https://raw.githubusercontent.com/cloudnative-pg/cloudnative-pg/release-1.29/releases/cnpg-1.29.1.yaml",
	}
...
func TestDeployInstance(t *testing.T) {
	...
	for _, ic := range pod.Spec.InitContainers {
		...
		if !ok {
			t.Fatalf("Memory limit not set on %s container", ic.Name)
		}
